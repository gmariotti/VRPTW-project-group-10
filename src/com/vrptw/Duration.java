...
/**
 * This class takes calculates duration in hours,minutes,seconds and milliseconds. Usage may be by
 * setting the values of start and end times or duration or by calling start and stop which gets the
 * system time in those moments.
 * 
 * @author Banea George
 * 
 */
public class Duration {
	...
	/**
	 * This function updates hours, minutes, seconds and milliseconds based on duration. Call this
	 * function each time duration changes
	 */
