...
public class CopyOfMySolution extends SolutionAdapter {
	 ...
	 */
	public CopyOfMySolution(Instance instance) {
		super();
	...
	public Object clone() {
		...
		CopyOfMySolution clonedSolution = (CopyOfMySolution) solution;
